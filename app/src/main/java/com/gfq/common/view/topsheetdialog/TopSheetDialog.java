...
public class TopSheetDialog extends AppCompatDialog {
    ...
    public TopSheetBehavior<FrameLayout> getTopSheetBehavior() {
        return topSheetBehavior;
    }

    public void setTopSheetCallback(TopSheetBehavior.TopSheetCallback callback) {
        this.mTopSheetCallback = callback;
    }
}
