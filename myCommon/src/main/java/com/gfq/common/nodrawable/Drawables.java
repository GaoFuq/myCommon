package com.gfq.common.nodrawable;
 ...
 * @link {https://github.com/whataa/noDrawable}
 */
...
public class Drawables {
    ...
    private static void setRingValue(GradientDrawable drawable,
        ...
        try {
            @SuppressLint("SoonBlockedPrivateApi") Field mGradientState = drawable.getClass().getDeclaredField("mGradientState");
